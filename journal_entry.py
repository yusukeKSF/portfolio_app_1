# --- 減価償却費 計算ロジックの強化　会計期間と減価償却費の算出期間の判別 ---
...
def calculate_depreciation_by_year(starting_date, closing_date, method, price, life, target_year=None):
    options = Options()
...
#                         closing_date=result_json.get("closing_date"),
